...
/*
|--------------------------------------------------------------------------
| Layanan Desa (informasi saja, tidak ada input data warga)
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| Kontak Kami (form beneran, masuk ke admin)
|--------------------------------------------------------------------------
*/
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin.auth')->group(function () {
        ...
        Route::resource('kontak', AdminKontakController::class)->only(['index', 'edit', 'update', 'destroy'])->parameters(['kontak' => 'kontak']);

        Route::resource('dusun', AdminDusunController::class)->except('show')->parameters(['dusun' => 'dusun']);
